...
user_input_sender = st.text_area("who is the sender?")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
user_input_receiver = st.text_area("who is the receiver?")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
user_input_amount = st.text_area("what is the amount?")
...
if st.button("Add Block"):
    ...
    data=input_data,
    creator_id=42,
    record=Record(user_imput_sender, user_imput_receiver, user_imput_amount),
